...
Trip.reopenClass({
  FIXTURES: [
    ...
    {
      id: 'olympia_toskana',
      name: 'Olympia Paris & Toskana',
      year: '2024',
      videos: ['frankfurt2','paris1','paris2','paris3','marseille','chenonceau','chinon','epeigne_les_bois','paris4','arezzo'],
      finished: true
    },
    {
      id: 'oscars',
      name: 'Oscars',
      year: '2025',
      videos: ['sandstone_peak','simi_valley','los_angeles2','sequoia','kings_canyon','purisima_creek','sunnyvale'],
      finished: true
    },
    {
      id: 'spitzingsee',
      name: 'Spitzingsee',
      year: '2025',
      videos: ['stuempfling','spitzingsee'],
      finished: true
    }
  ]
});
