...
test('about text shows actual content', function(assert) {
  ...
  andThen(function() {
    ...
    assert.equal(find('.about a[href="https://github.com/stoman/travelvideo"]').length, 1, 'link to GitHub should be visible');
    assert.equal(find('.about a[href="https://www.facebook.com/stefan.toman"]').length, 1, 'link to Facebook should be visible');
  });
});
